...
if res != "1" and res != "2" and res != "3" and res != "4" and res != "5" and res != "6" and res != "7":
    ...
    os.system("taskset -c 4-7 startplasma-x11 & sleep 5 && xrandr --output X11-0 --mode " + res + " &>/dev/null &")
elif res == "6":
    if 'WD' in os.environ:
        exit()
    else:
    ...
    if res == "4":
        res = "1920x1080"
    print("\033[0;33mTermux-X11 started. Type \033[0;36m'1'\033[0;33m (or any key) to exit from Box64Droid or \033[0;36m'2'\033[0;33m to back to start menu then press enter\033[0m")
    os.system("taskset -c 4-7 startplasma-x11 & sleep 5 && xrandr --output X11-0 --mode " + res + " &>/dev/null &")
